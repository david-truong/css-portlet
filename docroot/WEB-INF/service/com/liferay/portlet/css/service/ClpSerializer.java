...
import com.liferay.portlet.css.model.CSSEntryClp;
...
public class ClpSerializer {
	public static final String SERVLET_CONTEXT_NAME = "css-portlet";
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(CSSEntryClp.class.getName())) {
			CSSEntryClp oldCplModel = (CSSEntryClp)oldModel;
			...
			try {
				...
				try {
					Class<?> newModelClass = Class.forName("com.liferay.portlet.css.model.impl.CSSEntryImpl",
							true, _classLoader);
					...
					Method method1 = newModelClass.getMethod("setCssEntryId",
							new Class[] { Long.TYPE });

					Long value1 = new Long(oldCplModel.getCssEntryId());
					...
					Method method4 = newModelClass.getMethod("setCss",
							new Class[] { String.class });

					String value4 = oldCplModel.getCss();
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.liferay.portlet.css.model.impl.CSSEntryImpl")) {
			ClassLoader contextClassLoader = Thread.currentThread()
												   .getContextClassLoader();
			...
			try {
				...
				try {
					CSSEntryClp newModel = new CSSEntryClp();
					...
					Method method1 = oldModelClass.getMethod("getCssEntryId");

					Long value1 = (Long)method1.invoke(oldModel, (Object[])null);

					newModel.setCssEntryId(value1);
					...
					Method method4 = oldModelClass.getMethod("getCss");

					String value4 = (String)method4.invoke(oldModel,
							(Object[])null);

					newModel.setCss(value4);
